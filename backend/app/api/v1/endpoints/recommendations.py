...
from app.features.services import format_recommendations
from app.intent.detector import detect_intent

router = APIRouter()

@router.post("/recommendations", response_model=AnalysisResponse)
async def recommendations_analysis(
    ...
    analysis_text = format_recommendations(data)

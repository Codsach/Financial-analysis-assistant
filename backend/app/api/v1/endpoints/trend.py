# backend/app/api/v1/endpoints/trend.py
...
from app.features.repository import get_financial_data, get_trend_data_for_branch
from app.features.services import format_trend_analysis
...
async def trend_analysis(
    ...
    trend_rows, trend_ids = await get_trend_data_for_branch(
        db, data["branch"].branch_id, data["period"].start_date.year
    )

    all_record_ids = list(set(data["record_ids"] + trend_ids))
    analysis_text = format_trend_analysis(data, trend_rows)

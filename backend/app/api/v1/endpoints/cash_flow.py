# backend/app/api/v1/endpoints/cash_flow.py
...
from app.features.services import format_cash_flow
from app.intent.detector import detect_intent

router = APIRouter()

@router.post("/cash-flow", response_model=AnalysisResponse)
async def cash_flow_analysis(
    ...
    analysis_text = format_cash_flow(data)

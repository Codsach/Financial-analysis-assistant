...
from app.features.services import format_expense_analysis
from app.intent.detector import detect_intent

router = APIRouter()

@router.post("/expense", response_model=AnalysisResponse)
async def expense_analysis(
    ...
    analysis_text = format_expense_analysis(data)

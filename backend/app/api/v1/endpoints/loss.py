# backend/app/api/v1/endpoints/loss.py
...
from app.features.services import format_loss_analysis
from app.intent.detector import detect_intent

router = APIRouter()

@router.post("/loss", response_model=AnalysisResponse)
async def loss_analysis(
    ...
    analysis_text = format_loss_analysis(data)

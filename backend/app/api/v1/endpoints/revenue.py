# backend/app/api/v1/endpoints/revenue.py
...
from app.features.services import format_revenue_analysis
from app.intent.detector import detect_intent

router = APIRouter()

@router.post("/revenue", response_model=AnalysisResponse)
async def revenue_analysis(
    ...
    analysis_text = format_revenue_analysis(data)

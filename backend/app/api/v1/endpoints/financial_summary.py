# backend/app/api/v1/endpoints/financial_summary.py
...
from app.features.services import format_financial_summary
from app.intent.detector import detect_intent

router = APIRouter()

@router.post("/financial-summary", response_model=AnalysisResponse)
async def financial_summary(
    ...
    analysis_text = format_financial_summary(data)

# backend/app/api/v1/endpoints/balance_sheet.py
...
from app.features.services import format_balance_sheet
from app.intent.detector import detect_intent

router = APIRouter()

@router.post("/balance-sheet", response_model=AnalysisResponse)
async def balance_sheet_analysis(
    ...
    analysis_text = format_balance_sheet(data)
